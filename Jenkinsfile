...
def ping_test() {
                ...
                sh """  
doping () {
curl -O ftp://ftp.server/test_file --user admin: <file #first run with the command to copy a test file from the server, then comment out or delete the command. then use the command to write the file to ftp
